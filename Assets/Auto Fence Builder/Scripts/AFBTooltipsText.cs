...
public static class AFBTooltipsText {
	...
	//public const string useSecondaryRails = "Enable this to add a 2nd independent set of rails to the fence.";
	...
	public const string numRailsA = "The number of rails stacked vertically within each section of fence.";
	...
	public const string mainPostSizeBoost = "Boosts the size of the main (user click-point) posts, not the interpolated posts. Good for extra variation.";
